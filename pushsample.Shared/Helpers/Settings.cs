  ...
  public static class Settings
	{
		...
		public static string FBUserId
		{
			get
			{
				return AppSettings.GetValueOrDefault(_fbUserId, null);
			}
			set
			{
		...
		public static string AzureNHID
		{
			get
			{
				return AppSettings.GetValueOrDefault(_azureNHId, null);
			}
			set
			{
        ...
        public static bool IsRegisteredForPushNotifications
		{
			get
			{
                return AppSettings.GetValueOrDefault(isRegisteredForPushNotifs, false);
			}
			set
			{
		...
		public static User CurrentUser
		{
			get
			{
				string obj = AppSettings.GetValueOrDefault(CurrentUserIdKey, DefaultCurrentUserId);
				if (obj == "null" || obj == "")
				{
					return new User();
				}
			...
			set
			{
				AppSettings.AddOrUpdateValue(CurrentUserIdKey, JsonConvert.SerializeObject(value));
			}
		}
	}
}